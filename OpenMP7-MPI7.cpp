...
The implementation will use 7 nodes if needed.  In this case, an additional 7 threads will
also be used if needed.  After one recursive call of the multiplication algorithm, any
additional recursive calls will use one node/thread.
